...
public struct ColoringSdkConfiguration {
    ...
    public init(image: FlutterStandardTypedData, initialColor: String, session: String? = nil, colorPresets: [String], localizations: ColoringSdkLocalizations, theme: ColoringSdkTheme) {
        self.image = image
...
private class apiPigeonCodecWriter: FlutterStandardWriter {
    override func writeValue(_ value: Any) {
        if let value = value as? ColoringSdkConfiguration {
            super.writeByte(129)
...
class FlutterColoringApi: FlutterColoringApiProtocol {
